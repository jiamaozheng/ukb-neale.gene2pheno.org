...
var s3exp_config = {Bucket: 'gene2pheno', Prefix: '', Delimiter: '/' };
...
$(document).ready(function(){
    ...
    function renderKey(data, type, full) {
        if (isfolder(data)) {
            ...
            return '<a data-s3="object" href="' + object2href(s3exp_config.Bucket, data) + '"   onclick=" trackOutboundLink(' + '' + object2href(s3exp_config.Bucket, data) + '' + '); return false; ">' + fullpath2filename(data) + '</a>';
        }
    }
